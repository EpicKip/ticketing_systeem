...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'EventTemplate.somedata'
        db.delete_column(u'tickets_eventtemplate', 'somedata')

        # Adding field 'EventTemplate.text'
        db.add_column(u'tickets_eventtemplate', 'text',
                      self.gf('django.db.models.fields.TextField')(default=1),
                      keep_default=False)

        # Deleting field 'TicketTemplate.somedata'
        db.delete_column(u'tickets_tickettemplate', 'somedata')

        # Adding field 'TicketTemplate.text'
        db.add_column(u'tickets_tickettemplate', 'text',
                      self.gf('django.db.models.fields.TextField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'EventTemplate.somedata'
        db.add_column(u'tickets_eventtemplate', 'somedata',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=1000),
                      keep_default=False)

        # Deleting field 'EventTemplate.text'
        db.delete_column(u'tickets_eventtemplate', 'text')

        # Adding field 'TicketTemplate.somedata'
        db.add_column(u'tickets_tickettemplate', 'somedata',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=1000),
                      keep_default=False)

        # Deleting field 'TicketTemplate.text'
        db.delete_column(u'tickets_tickettemplate', 'text')
