...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EventTemplate.name'
        db.add_column(u'tickets_eventtemplate', 'name',
                      self.gf('django.db.models.fields.CharField')(default='default name :D', max_length=100),
                      keep_default=False)

        # Adding field 'TicketTemplate.name'
        db.add_column(u'tickets_tickettemplate', 'name',
                      self.gf('django.db.models.fields.CharField')(default='Default name :D', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EventTemplate.name'
        db.delete_column(u'tickets_eventtemplate', 'name')

        # Deleting field 'TicketTemplate.name'
        db.delete_column(u'tickets_tickettemplate', 'name')
