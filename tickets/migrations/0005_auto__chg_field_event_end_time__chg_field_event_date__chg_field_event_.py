...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'tickets_event', 'date', self.gf('django.db.models.fields.DateField')())
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Event.date'
        db.alter_column(u'tickets_event', 'date', self.gf('django.db.models.fields.DateTimeField')())
