...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'tickets_event', 'date')


    def backwards(self, orm):
        # Adding field 'Event.date'
        db.add_column(u'tickets_event', 'date',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2014, 4, 3, 0, 0)),
                      keep_default=False)
