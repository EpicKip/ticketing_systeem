...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'tickets_event', 'location', self.gf('django.db.models.fields.CharField')(default=1, max_length=200))

    def backwards(self, orm):

        # Changing field 'Event.location'
        db.alter_column(u'tickets_event', 'location', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))
